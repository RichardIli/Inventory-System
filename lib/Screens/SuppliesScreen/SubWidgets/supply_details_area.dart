...
class SupplyDetailsArea extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => RestockSupplyButtonBloc(
              suppliesDbRepo: suppliesRepo,
              usersDbRepo: usersDbRepo,
              auth: authDbRepo),
        ),
        BlocProvider(
            create: (context) => SupplyHistoryBloc(
                RepositoryProvider.of<FirestoreSuppliesDb>(context))),
      ],
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        BlocListener<RestockSupplyButtonBloc,
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: BlocListener<RestockSupplyButtonBloc,
                          RestockSupplyButtonState>(
                        listener: (context, state) {
                          if (state is RestockSupplyButtonLoaded) {
                            if (state.success) {
                              context.read<SupplyHistoryBloc>().add(
                                  FetchSupplyHistoryEvent(supplyID: supplyId));
                            } else {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(content: Text('Insertion failed')),
                              );
                        ...
                        child: Column(
                          children: [
                            ...
                            BlocBuilder<SupplyHistoryBloc, SupplyHistoryState>(
                              builder: (context, state) {
