      ...
      children: [
        ...
        Expanded(
          child: SingleChildScrollView(
            child: BlocBuilder<TransmitalHistoryListBloc,
                TransmitalHistoryListState>(
              builder: (context, state) {
                if (state is TransmitalHistoryListInitial) {
                  context
                      .read<TransmitalHistoryListBloc>()
                      .add(FetchTransmitalHistoryListEvent());
