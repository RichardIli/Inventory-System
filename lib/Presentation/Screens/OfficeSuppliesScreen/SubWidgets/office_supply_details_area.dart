...
import 'package:inventory_system/Presentation/Screens/OfficeSuppliesScreen/SubWidgets/restock_window.dart';
import 'package:inventory_system/Presentation/bloc/OfficeSuppliesScreenBlocs/OfficeSuppliesBloc/office_supplies_bloc.dart';
import 'package:inventory_system/Presentation/bloc/OfficeSuppliesScreenBlocs/OfficeSupplyHistoryBloc/office_supply_history_bloc.dart';
import 'package:inventory_system/Presentation/bloc/OfficeSuppliesScreenBlocs/RestockOfficeSupplyButtonBloc/restock_office_supply_button_bloc.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create:
              (context) => RestockOfficeSupplyButtonBloc(
                auth: authDbRepo,
                ...
                usersDbRepo: RepositoryProvider.of<FirestoreUsersDbRepository>(
                  context,
                ),
              ),
        ),
        BlocProvider(
          create:
              (context) => OfficeSupplyHistoryBloc(
                firestoreOfficeSupplies:
                    RepositoryProvider.of<FirestoreOfficeSupplies>(context),
                transmitalHistoryRepo:
                    RepositoryProvider.of<FirestoreTransmitalHistoryRepo>(
