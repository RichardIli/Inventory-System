...
import 'package:inventory_system/Presentation/bloc/OfficeSuppliesScreenBlocs/PullOutOfficeSuppliesFromDbBloc/pull_out_office_supplies_from_db_bloc.dart';
import 'package:inventory_system/Presentation/bloc/OfficeSuppliesScreenBlocs/PullOutOfficeSuppliesListBloc%20copy/pull_out_office_supplies_list_bloc.dart';
...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final pulloutOfficeSuppliesList =
        context.read<PullOutOfficeSuppliesListBloc>();
    final pulloutOfficeSuppliesFromDbBloc =
        context.read<PullOutOfficeSuppliesFromDbBloc>();
    ...
    return BlocListener<PullOutOfficeSuppliesFromDbBloc, PullOutOfficeSuppliesFromDbState>(
      listener: (context, state) {
        if (state is PulledOutOfficeSuppliesFromDb) {
          if (state.success) {
            showDialog(
              ...
              builder: (contetx) {
                return AlertDialog(
                  ...
                  actions: [
                    TextButton(
                      onPressed: () {
                        Navigator.pushNamed(context, officeSuppliesScreen);
                      },
                      child: Text("OK"),
                    ),
                  ],
        ...
        } else if (state is PullOutOfficeSuppliesFromDbStateError) {
                                    ...
                                    listener: (context, state) {
                                      if (state
                                        ...
                                        context
                                            ...
                                            >()
                                            .add(
                                              ResetPullOutOfficeSuppliesListEvent(),
                                            );
                                      }
                                    },
                                    child: Container(
