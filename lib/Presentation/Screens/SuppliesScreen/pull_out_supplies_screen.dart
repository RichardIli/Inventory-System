...
import 'package:inventory_system/Presentation/bloc/SuppliesScreenBlocs/PullOutSuppliesFromDbBloc/pull_out_supplies_from_db_bloc.dart';
import 'package:inventory_system/Presentation/bloc/SuppliesScreenBlocs/PullOutSuppliesListBloc%20copy/pull_out_supplies_list_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create:
              (context) => PullOutSuppliesListBloc(
        ...
        BlocProvider(
          create:
              (context) => PullOutSuppliesFromDbBloc(
...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<PullOutSuppliesFromDbBloc, PullOutSuppliesFromDbState>(
      listener: (context, state) {
        if (state is PulledOutSuppliesFromDb) {
          if (state.success) {
            showDialog(
        ...
        } else if (state is PullOutSuppliesFromDbStateError) {
