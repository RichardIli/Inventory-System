...
class PullOutToolsEquipmentsFromDbBloc extends Bloc<
    PullOutToolsEquipmentsFromDbEvent, PullOutToolsEquipmentsFromDbState> {
        ...
        for (var item in currentList) {
          try {
             toolsEquipmentsRepo.outItem(
                item["id"], user[0]["name"],outBy, requestBy, receivedOnSiteBy);
          } catch (e) {
            // ignore: avoid_print
